...
stop_thrsh = 5e-3; %Noise stop threshhold
noise_val = 0.2;
base=eye(N); 
for i = 1:N
...
figure (3)
subplot(2,2,1)
plot(1:size(WWW{1},2),WWW{1})
grid on
xlabel('Update Instances', 'FontSize', 16)
ylabel('Paramter Value', 'FontSize', 16)
title('Controller Parameter Values for Subsystem 1')
axis([0 40 -0.4 1.2])
subplot(2,2,2)
plot(1:size(WWW{2},2),WWW{2})
grid on
xlabel('Update Instances', 'FontSize', 16)
ylabel('Paramter Value', 'FontSize', 16)
title('Controller Parameter Values for Subsystem 2')
axis([0 40 -0.4 1.2])
subplot(2,2,3)
plot(1:size(WWW{3},2),WWW{3})
grid on
xlabel('Update Instances', 'FontSize', 16)
ylabel('Paramter Value', 'FontSize', 16)
title('Controller Parameter Values for Subsystem 3')
axis([0 40 -0.4 1.2])
subplot(2,2,4)
plot(1:size(WWW{4},2),WWW{4})
grid on
xlabel('Update Instances', 'FontSize', 16)
ylabel('Paramter Value', 'FontSize', 16)
title('Controller Parameter Values for Subsystem 4')
axis([0 40 -0.4 1.2])