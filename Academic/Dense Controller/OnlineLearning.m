...
% Za=eye(4);
% Za = zeros(4);
% z1=[1 1 1 4 5;2 3 0 4 1;5 3 -1 1 2; -2 -3 1 2 3];
% for i = 1:5
%     Za=Za + z1(:,i)*z1(:,i)';
% end
Za=eye(4);
...
for i = 1:samples
    ...
    if (j==l+1) 
        ...
        xxx=[];
        uuu=[];
%         [Kmf,Hmf,H11mf,H12Tmf,H22mf]=lmiSolverMF(D,X,cost,Z);
        [Ka,Ha,H11a,H12Ta,H22a,Wa,const2a]=lmiSolverMF(D,X,cost,Za);
%         [Kb,Hb,H11b,H12Tb,H22b,Wb,const2b]=lmiSolverMF(D,X,cost,Zb);
